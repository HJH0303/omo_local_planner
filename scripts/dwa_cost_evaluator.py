...
class CostEvaluator:
    ...
    def evaluate(self, vel_pairs, obstacle_cost, path_cost, alignment_cost, goal_cost, goal_center_cost):
        ...
        :param alignment_costs: list of alignment costs for each trajectory
        :param goal_costs: list of goal costs for each trajectory
        :param goal_center_cost: list of goal center costs for each trajectory
        ...
        # print("alignment_costs:   ", alignment_norm)
        # print("goal_costs:        ", goal_norm)
        # print("goal_center_costs: ", goal_center_norm)
